...
#include <BSMPT/models/ClassPotentialR2HDMEFTPHI6_PHI2PSI3.h> // for Class_Potential_R2HDMEFTPHI6_PHI2PSI3
...
CLIOptions::CLIOptions(int argc, char *argv[])
{
  ...
  if (argc == 24)
  {
    ...
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OL_1b12b  = std::stod(args.at(11));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OL_1b21b  = std::stod(args.at(12));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OL_2b11b  = std::stod(args.at(13));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OL_2b22b  = std::stod(args.at(14));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OQu_1b12b = std::stod(args.at(15));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OQu_1b21b = std::stod(args.at(16));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OQu_2b11b = std::stod(args.at(17));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OQu_2b22b = std::stod(args.at(18));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OQd_1b12b = std::stod(args.at(19));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OQd_1b21b = std::stod(args.at(20));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OQd_2b11b = std::stod(args.at(21));
    BSMPT::Models::Class_Potential_R2HDMEFTPHI6_PHI2PSI3::OQd_2b22b = std::stod(args.at(22));
  }
  else
  {
