...
Class_Potential_C2HDMEFT::Class_Potential_C2HDMEFT()
{
  ...
  Model         = ModelID::ModelIDs::C2HDMEFT;
  NNeutralHiggs = 4;
  NChargedHiggs = 4;
 ...
 */
std::vector<std::string> Class_Potential_C2HDMEFT::addLegendCT() const
{
 ...
 * inputfile
 */
std::vector<std::string> Class_Potential_C2HDMEFT::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_C2HDMEFT::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_C2HDMEFT::addLegendVEV() const
{
  std::vector<std::string> labels;
...
void Class_Potential_C2HDMEFT::ReadAndSet(const std::string &linestr,
...
void Class_Potential_C2HDMEFT::set_gen(const std::vector<double> &p)
{
...
void Class_Potential_C2HDMEFT::set_CT_Pot_Par(const std::vector<double> &p)
{
  //	double *p = (double *)par;
 ...
 */
void Class_Potential_C2HDMEFT::write() const
{
  std::stringstream ss;
 ...
 * conserving)
 */
std::vector<double> Class_Potential_C2HDMEFT::calc_CT() const
{
...
void Class_Potential_C2HDMEFT::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_C2HDMEFT::SetCurvatureArrays()
{
  initVectors();
  ...
  Curvature_Higgs_L6[0][0][0][0][0][0] =
      0.90e2 * pow(Lambda, -0.2e1) * Op6_111111;
  ...
  Curvature_Higgs_L6[0][0][0][1][2][3] =
      0.6e1 * pow(Lambda, -0.2e1) * Op6_121211;
  Curvature_Higgs_L6[0][0][0][2][4][6] =
      (double)(3 * Op6_122111 + 6 * Op6_121211) * pow(Lambda, -0.2e1) / 0.2e1;
  ...
  Curvature_Higgs_L6[0][0][1][1][2][2] =
      pow(Lambda, -0.2e1) * (double)(2 * Op6_111122 + 2 * Op6_122111);
  ...
  Curvature_Higgs_L6[0][0][1][2][4][7] =
      (double)(-Op6_122111 + 2 * Op6_121211) * pow(Lambda, -0.2e1) / 0.2e1;
  ...
  Curvature_Higgs_L6[0][0][6][6][7][7] =
      0.2e1 * pow(Lambda, -0.2e1) * Op6_112222;
  ...
  Curvature_Higgs_L6[0][1][2][2][2][3] =
      0.6e1 * pow(Lambda, -0.2e1) * Op6_121222;
  ...
  Curvature_Higgs_L6[0][2][2][2][4][6] =
      (double)(3 * Op6_122122 + 6 * Op6_121222) * pow(Lambda, -0.2e1) / 0.2e1;
  Curvature_Higgs_L6[0][2][2][2][5][7] =
      (double)(3 * Op6_122122 + 6 * Op6_121222) * pow(Lambda, -0.2e1) / 0.2e1;
  Curvature_Higgs_L6[0][2][2][3][4][7] =
      (double)(Op6_122122 - 2 * Op6_121222) * pow(Lambda, -0.2e1) / 0.2e1;
  ...
  Curvature_Higgs_L6[2][2][2][2][2][2] =
      0.90e2 * pow(Lambda, -0.2e1) * Op6_222222;
  ...
  Curvature_Higgs_L6[2][2][3][3][6][6] =
      0.6e1 * pow(Lambda, -0.2e1) * Op6_222222;
  ...
  Curvature_Higgs_L6[4][4][6][6][7][7] =
      pow(Lambda, -0.2e1) * (double)(2 * Op6_112222 + 2 * Op6_122122);
...
bool Class_Potential_C2HDMEFT::CalculateDebyeSimplified()
{
  double cb = 0;
...
bool Class_Potential_C2HDMEFT::CalculateDebyeGaugeSimplified()
{
...
double
Class_Potential_C2HDMEFT::VTreeSimplified(const std::vector<double> &v) const
{
  double res = 0;
...
double
Class_Potential_C2HDMEFT::VCounterSimplified(const std::vector<double> &v) const
{
...
void Class_Potential_C2HDMEFT::Debugging(const std::vector<double> &input,
