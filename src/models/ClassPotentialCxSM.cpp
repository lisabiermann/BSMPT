...
std::vector<double>
Class_CxSM::GetAlphaVec(const std::vector<double> &point) const
{
  (void)point;
...
double
Class_CxSM::SymFac_Higgs_TempPowerTwo(const int &i,
                                      const int &j,
...
double Class_CxSM::SymFac_Higgs_TempPowerFour(const int &i, const int &j) const
{
  (void)i;
  (void)j;
  return 0;
