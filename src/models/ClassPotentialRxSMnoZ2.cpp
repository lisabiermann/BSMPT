...
#include <BSMPT/models/ClassPotentialRxSMnoZ2.h>
 ...
 */
Class_RxSMnoZ2::Class_RxSMnoZ2(const ISMConstants &smConstants)
 ...
 */
std::vector<std::string> Class_RxSMnoZ2::addLegendCT() const
{
 ...
 * input file
 */
std::vector<std::string> Class_RxSMnoZ2::addLegendTemp() const
{
  std::vector<std::string> labels;
 ...
 *
 */
std::vector<std::string> Class_RxSMnoZ2::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_RxSMnoZ2::addLegendVEV() const
{
  std::vector<std::string> labels;
  // out = "Your VEV order";
 ...
 */
void Class_RxSMnoZ2::ReadAndSet(const std::string &linestr,
                                std::vector<double> &par)
{
  std::stringstream ss(linestr);
  double tmp;

  double lambdaIn{0}, a1In{0}, a2In{0}, b3In{0}, b4In{0}, vSIn{0};
 ...
 */
void Class_RxSMnoZ2::set_gen(const std::vector<double> &par)
{
  lambda = par[0];
  a1     = par[1];
  a2     = par[2];
  ...
  musq = lambda*vH*vH + (a1 + a2*vS)*vS/2.;
  b2   = -(2*a2*vH*vH*vS + 4*b4*vS*vS*vS + a1*vH*vH + 4*b3*vS*vS)/(4*vS);
 ...
 */
void Class_RxSMnoZ2::set_CT_Pot_Par(const std::vector<double> &par)
{
  ...
  Curvature_Higgs_CT_L2[4][4] = db2;

  Curvature_Higgs_CT_L3[0][0][4] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[0][4][0] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[1][1][4] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[1][4][1] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[2][2][4] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[2][4][2] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[3][3][4] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[3][4][3] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[4][0][0] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[4][1][1] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[4][2][2] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[4][3][3] = da1 / 0.2e1;
  Curvature_Higgs_CT_L3[4][4][4] = 2 * db3;
  ...
  Curvature_Higgs_CT_L4[0][0][4][4] = da2;
  Curvature_Higgs_CT_L4[0][1][0][1] = 2 * dlambda;
  Curvature_Higgs_CT_L4[0][1][1][0] = 2 * dlambda;
  Curvature_Higgs_CT_L4[0][2][0][2] = 2 * dlambda;
  Curvature_Higgs_CT_L4[0][2][2][0] = 2 * dlambda;
  Curvature_Higgs_CT_L4[0][3][0][3] = 2 * dlambda;
  Curvature_Higgs_CT_L4[0][3][3][0] = 2 * dlambda;
  Curvature_Higgs_CT_L4[0][4][0][4] = da2;
  Curvature_Higgs_CT_L4[0][4][4][0] = da2;
  Curvature_Higgs_CT_L4[1][0][0][1] = 2 * dlambda;
  Curvature_Higgs_CT_L4[1][0][1][0] = 2 * dlambda;
  Curvature_Higgs_CT_L4[1][1][0][0] = 2 * dlambda;
  Curvature_Higgs_CT_L4[1][1][1][1] = 6 * dlambda;
  Curvature_Higgs_CT_L4[1][1][2][2] = 2 * dlambda;
  Curvature_Higgs_CT_L4[1][1][3][3] = 2 * dlambda;
  Curvature_Higgs_CT_L4[1][1][4][4] = da2;
  Curvature_Higgs_CT_L4[1][2][1][2] = 2 * dlambda;
  Curvature_Higgs_CT_L4[1][2][2][1] = 2 * dlambda;
  Curvature_Higgs_CT_L4[1][3][1][3] = 2 * dlambda;
  Curvature_Higgs_CT_L4[1][3][3][1] = 2 * dlambda;
  Curvature_Higgs_CT_L4[1][4][1][4] = da2;
  Curvature_Higgs_CT_L4[1][4][4][1] = da2;
  Curvature_Higgs_CT_L4[2][0][0][2] = 2 * dlambda;
  Curvature_Higgs_CT_L4[2][0][2][0] = 2 * dlambda;
  Curvature_Higgs_CT_L4[2][1][1][2] = 2 * dlambda;
  Curvature_Higgs_CT_L4[2][1][2][1] = 2 * dlambda;
  Curvature_Higgs_CT_L4[2][2][0][0] = 2 * dlambda;
  Curvature_Higgs_CT_L4[2][2][1][1] = 2 * dlambda;
  Curvature_Higgs_CT_L4[2][2][2][2] = 6 * dlambda;
  Curvature_Higgs_CT_L4[2][2][3][3] = 2 * dlambda;
  Curvature_Higgs_CT_L4[2][2][4][4] = da2;
  Curvature_Higgs_CT_L4[2][3][2][3] = 2 * dlambda;
  Curvature_Higgs_CT_L4[2][3][3][2] = 2 * dlambda;
  Curvature_Higgs_CT_L4[2][4][2][4] = da2;
  Curvature_Higgs_CT_L4[2][4][4][2] = da2;
  Curvature_Higgs_CT_L4[3][0][0][3] = 2 * dlambda;
  Curvature_Higgs_CT_L4[3][0][3][0] = 2 * dlambda;
  Curvature_Higgs_CT_L4[3][1][1][3] = 2 * dlambda;
  Curvature_Higgs_CT_L4[3][1][3][1] = 2 * dlambda;
  Curvature_Higgs_CT_L4[3][2][2][3] = 2 * dlambda;
  Curvature_Higgs_CT_L4[3][2][3][2] = 2 * dlambda;
  Curvature_Higgs_CT_L4[3][3][0][0] = 2 * dlambda;
  Curvature_Higgs_CT_L4[3][3][1][1] = 2 * dlambda;
  Curvature_Higgs_CT_L4[3][3][2][2] = 2 * dlambda;
  Curvature_Higgs_CT_L4[3][3][3][3] = 6 * dlambda;
  Curvature_Higgs_CT_L4[3][3][4][4] = da2;
  Curvature_Higgs_CT_L4[3][4][3][4] = da2;
  Curvature_Higgs_CT_L4[3][4][4][3] = da2;
  Curvature_Higgs_CT_L4[4][0][0][4] = da2;
  Curvature_Higgs_CT_L4[4][0][4][0] = da2;
  Curvature_Higgs_CT_L4[4][1][1][4] = da2;
  Curvature_Higgs_CT_L4[4][1][4][1] = da2;
  Curvature_Higgs_CT_L4[4][2][2][4] = da2;
  Curvature_Higgs_CT_L4[4][2][4][2] = da2;
  Curvature_Higgs_CT_L4[4][3][3][4] = da2;
  Curvature_Higgs_CT_L4[4][3][4][3] = da2;
  Curvature_Higgs_CT_L4[4][4][0][0] = da2;
  Curvature_Higgs_CT_L4[4][4][1][1] = da2;
  Curvature_Higgs_CT_L4[4][4][2][2] = da2;
  Curvature_Higgs_CT_L4[4][4][3][3] = da2;
  Curvature_Higgs_CT_L4[4][4][4][4] = 6 * db4;
 ...
 */
void Class_RxSMnoZ2::write() const
{
 ...
 */
std::vector<double> Class_RxSMnoZ2::calc_CT() const
{
  ...
  else
  {
    ...
    // // dmusq
    // parCT.push_back((3 * HesseWeinberg(2, 2) * vH * vH - HesseWeinberg(3, 3) * vH * vH - vS * (HesseWeinberg(3, 4) * vH - 2 * HesseWeinberg(4, 4) * vS + 2 * NablaWeinberg(4))) * pow(vH, -2) / 2);
    //
    // // dlambda
    // parCT.push_back(pow(vH, -2) * (HesseWeinberg(2, 2) - HesseWeinberg(3, 3)) / 2);
    //
    // // da1
    // parCT.push_back((4 * HesseWeinberg(4, 4) * vS - 4 * NablaWeinberg(4)) * pow(vH, -2));
    //
    // // da2
    // parCT.push_back((-HesseWeinberg(3, 4) * vH - 2 * HesseWeinberg(4, 4) * vS + 2 * NablaWeinberg(4)) * pow(vH, -2) / vS);
    //
    // // db2
    // parCT.push_back((HesseWeinberg(3, 4) * vH - 2 * NablaWeinberg(4)) / vS / 2);
    //
    // // db3
    // parCT.push_back(0);
    //
    ...
    // da1
    parCT.push_back((-6 * HesseWeinberg(2, 2) * vH + 2 * HesseWeinberg(3, 3) * vH + 2 * HesseWeinberg(3, 4) * vS) / vS / vH);

    // da2
    parCT.push_back((3 * HesseWeinberg(2, 2) * vH - HesseWeinberg(3, 3) * vH - 2 * HesseWeinberg(3, 4) * vS) * pow(vS, -2) / vH);

    // db2
    parCT.push_back(0);

    // db3
    parCT.push_back((3 * HesseWeinberg(2, 2) * vH * vH - HesseWeinberg(3, 3) * vH * vH + vS * (vH * HesseWeinberg(3, 4) + 2 * vS * HesseWeinberg(4, 4) - 6 * NablaWeinberg(4))) * pow(vS, -3) / 2);

    // db4
    parCT.push_back((-3 * HesseWeinberg(2, 2) * vH * vH + HesseWeinberg(3, 3) * vH * vH - 2 * HesseWeinberg(4, 4) * vS * vS + 4 * NablaWeinberg(4) * vS) * pow(vS, -4) / 2);
 ...
 */
void Class_RxSMnoZ2::AdjustRotationMatrix()
{
  const double ZeroThreshold = 1e-5;
...
void Class_RxSMnoZ2::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
  if (!CalcCouplingsDone) CalculatePhysicalCouplings();
...
void Class_RxSMnoZ2::SetCurvatureArrays()
{
  initVectors();
  ...
  Curvature_Higgs_L2[4][4] = b2;

  Curvature_Higgs_L3[0][0][4] = a1 / 0.2e1;
  Curvature_Higgs_L3[0][4][0] = a1 / 0.2e1;
  Curvature_Higgs_L3[1][1][4] = a1 / 0.2e1;
  Curvature_Higgs_L3[1][4][1] = a1 / 0.2e1;
  Curvature_Higgs_L3[2][2][4] = a1 / 0.2e1;
  Curvature_Higgs_L3[2][4][2] = a1 / 0.2e1;
  Curvature_Higgs_L3[3][3][4] = a1 / 0.2e1;
  Curvature_Higgs_L3[3][4][3] = a1 / 0.2e1;
  Curvature_Higgs_L3[4][0][0] = a1 / 0.2e1;
  Curvature_Higgs_L3[4][1][1] = a1 / 0.2e1;
  Curvature_Higgs_L3[4][2][2] = a1 / 0.2e1;
  Curvature_Higgs_L3[4][3][3] = a1 / 0.2e1;
  Curvature_Higgs_L3[4][4][4] = 2 * b3;
  ...
  Curvature_Higgs_L4[0][0][4][4] = a2;
  Curvature_Higgs_L4[0][1][0][1] = 2 * lambda;
  Curvature_Higgs_L4[0][1][1][0] = 2 * lambda;
  Curvature_Higgs_L4[0][2][0][2] = 2 * lambda;
  Curvature_Higgs_L4[0][2][2][0] = 2 * lambda;
  Curvature_Higgs_L4[0][3][0][3] = 2 * lambda;
  Curvature_Higgs_L4[0][3][3][0] = 2 * lambda;
  Curvature_Higgs_L4[0][4][0][4] = a2;
  Curvature_Higgs_L4[0][4][4][0] = a2;
  Curvature_Higgs_L4[1][0][0][1] = 2 * lambda;
  Curvature_Higgs_L4[1][0][1][0] = 2 * lambda;
  Curvature_Higgs_L4[1][1][0][0] = 2 * lambda;
  Curvature_Higgs_L4[1][1][1][1] = 6 * lambda;
  Curvature_Higgs_L4[1][1][2][2] = 2 * lambda;
  Curvature_Higgs_L4[1][1][3][3] = 2 * lambda;
  Curvature_Higgs_L4[1][1][4][4] = a2;
  Curvature_Higgs_L4[1][2][1][2] = 2 * lambda;
  Curvature_Higgs_L4[1][2][2][1] = 2 * lambda;
  Curvature_Higgs_L4[1][3][1][3] = 2 * lambda;
  Curvature_Higgs_L4[1][3][3][1] = 2 * lambda;
  Curvature_Higgs_L4[1][4][1][4] = a2;
  Curvature_Higgs_L4[1][4][4][1] = a2;
  Curvature_Higgs_L4[2][0][0][2] = 2 * lambda;
  Curvature_Higgs_L4[2][0][2][0] = 2 * lambda;
  Curvature_Higgs_L4[2][1][1][2] = 2 * lambda;
  Curvature_Higgs_L4[2][1][2][1] = 2 * lambda;
  Curvature_Higgs_L4[2][2][0][0] = 2 * lambda;
  Curvature_Higgs_L4[2][2][1][1] = 2 * lambda;
  Curvature_Higgs_L4[2][2][2][2] = 6 * lambda;
  Curvature_Higgs_L4[2][2][3][3] = 2 * lambda;
  Curvature_Higgs_L4[2][2][4][4] = a2;
  Curvature_Higgs_L4[2][3][2][3] = 2 * lambda;
  Curvature_Higgs_L4[2][3][3][2] = 2 * lambda;
  Curvature_Higgs_L4[2][4][2][4] = a2;
  Curvature_Higgs_L4[2][4][4][2] = a2;
  Curvature_Higgs_L4[3][0][0][3] = 2 * lambda;
  Curvature_Higgs_L4[3][0][3][0] = 2 * lambda;
  Curvature_Higgs_L4[3][1][1][3] = 2 * lambda;
  Curvature_Higgs_L4[3][1][3][1] = 2 * lambda;
  Curvature_Higgs_L4[3][2][2][3] = 2 * lambda;
  Curvature_Higgs_L4[3][2][3][2] = 2 * lambda;
  Curvature_Higgs_L4[3][3][0][0] = 2 * lambda;
  Curvature_Higgs_L4[3][3][1][1] = 2 * lambda;
  Curvature_Higgs_L4[3][3][2][2] = 2 * lambda;
  Curvature_Higgs_L4[3][3][3][3] = 6 * lambda;
  Curvature_Higgs_L4[3][3][4][4] = a2;
  Curvature_Higgs_L4[3][4][3][4] = a2;
  Curvature_Higgs_L4[3][4][4][3] = a2;
  Curvature_Higgs_L4[4][0][0][4] = a2;
  Curvature_Higgs_L4[4][0][4][0] = a2;
  Curvature_Higgs_L4[4][1][1][4] = a2;
  Curvature_Higgs_L4[4][1][4][1] = a2;
  Curvature_Higgs_L4[4][2][2][4] = a2;
  Curvature_Higgs_L4[4][2][4][2] = a2;
  Curvature_Higgs_L4[4][3][3][4] = a2;
  Curvature_Higgs_L4[4][3][4][3] = a2;
  Curvature_Higgs_L4[4][4][0][0] = a2;
  Curvature_Higgs_L4[4][4][1][1] = a2;
  Curvature_Higgs_L4[4][4][2][2] = a2;
  Curvature_Higgs_L4[4][4][3][3] = a2;
  Curvature_Higgs_L4[4][4][4][4] = 6 * b4;
...
bool Class_RxSMnoZ2::CalculateDebyeSimplified()
{
  return false;
  /*
...
bool Class_RxSMnoZ2::CalculateDebyeGaugeSimplified()
{
  /*
...
double Class_RxSMnoZ2::VTreeSimplified(const std::vector<double> &v) const
{
  (void)v;
...
double Class_RxSMnoZ2::VCounterSimplified(const std::vector<double> &v) const
{
  (void)v;
...
void Class_RxSMnoZ2::Debugging(const std::vector<double> &input,
