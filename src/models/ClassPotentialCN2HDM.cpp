...
void Class_Potential_CN2HDM::SetCurvatureArrays()
{
  ...
  if (Type == 1 or Type == 3)
  {
    Curvature_Lepton_F2H1[0][1][6] = 0.1e1 / vL * C_MassElectron;
    Curvature_Lepton_F2H1[0][1][7] = II / vL * C_MassElectron;
    Curvature_Lepton_F2H1[1][0][6] = 0.1e1 / vL * C_MassElectron;
    Curvature_Lepton_F2H1[1][0][7] = II / vL * C_MassElectron;
    Curvature_Lepton_F2H1[1][6][2] = 0.1e1 / vL * C_MassElectron;
    Curvature_Lepton_F2H1[1][6][3] = II / vL * C_MassElectron;
    Curvature_Lepton_F2H1[2][3][6] = 0.1e1 / vL * C_MassMu;
    Curvature_Lepton_F2H1[2][3][7] = II / vL * C_MassMu;
    Curvature_Lepton_F2H1[3][2][6] = 0.1e1 / vL * C_MassMu;
    Curvature_Lepton_F2H1[3][2][7] = II / vL * C_MassMu;
    Curvature_Lepton_F2H1[3][7][2] = 0.1e1 / vL * C_MassMu;
    Curvature_Lepton_F2H1[3][7][3] = II / vL * C_MassMu;
    Curvature_Lepton_F2H1[4][5][6] = 0.1e1 / vL * C_MassTau;
    Curvature_Lepton_F2H1[4][5][7] = II / vL * C_MassTau;
    Curvature_Lepton_F2H1[5][4][6] = 0.1e1 / vL * C_MassTau;
    Curvature_Lepton_F2H1[5][4][7] = II / vL * C_MassTau;
    Curvature_Lepton_F2H1[5][8][2] = 0.1e1 / vL * C_MassTau;
    Curvature_Lepton_F2H1[5][8][3] = II / vL * C_MassTau;
    Curvature_Lepton_F2H1[6][1][2] = 0.1e1 / vL * C_MassElectron;
    Curvature_Lepton_F2H1[6][1][3] = II / vL * C_MassElectron;
    Curvature_Lepton_F2H1[7][3][2] = 0.1e1 / vL * C_MassMu;
    Curvature_Lepton_F2H1[7][3][3] = II / vL * C_MassMu;
    Curvature_Lepton_F2H1[8][5][2] = 0.1e1 / vL * C_MassTau;
    Curvature_Lepton_F2H1[8][5][3] = II / vL * C_MassTau;
  }
  else // Type 2 or Type 4
  {
  ...
  if (Type == 1 or Type == 4)
  {
    Curvature_Quark_F2H1[0][1][6]  = 0.1e1 / v2 * C_MassUp;
    Curvature_Quark_F2H1[0][1][7]  = -II / v2 * C_MassUp;
    Curvature_Quark_F2H1[0][3][2]  = V11 / v2 * C_MassDown;
    Curvature_Quark_F2H1[0][3][3]  = II * V11 / v2 * C_MassDown;
    Curvature_Quark_F2H1[0][7][2]  = 0.1e1 / v2 * C_MassStrange * V12;
    Curvature_Quark_F2H1[0][7][3]  = II / v2 * C_MassStrange * V12;
    Curvature_Quark_F2H1[0][11][2] = 0.1e1 / v2 * C_MassBottom * V13;
    Curvature_Quark_F2H1[0][11][3] = II / v2 * C_MassBottom * V13;
    Curvature_Quark_F2H1[1][0][6]  = 0.1e1 / v2 * C_MassUp;
    Curvature_Quark_F2H1[1][0][7]  = -II / v2 * C_MassUp;
    Curvature_Quark_F2H1[1][2][2]  = -0.1e1 / v2 * C_MassUp * std::conj(V11);
    Curvature_Quark_F2H1[1][2][3]  = II / v2 * C_MassUp * std::conj(V11);
    Curvature_Quark_F2H1[1][6][2]  = -0.1e1 / v2 * C_MassUp * std::conj(V12);
    Curvature_Quark_F2H1[1][6][3]  = II / v2 * C_MassUp * std::conj(V12);
    Curvature_Quark_F2H1[1][10][2] = -0.1e1 / v2 * C_MassUp * std::conj(V13);
    Curvature_Quark_F2H1[1][10][3] = II / v2 * C_MassUp * std::conj(V13);
    Curvature_Quark_F2H1[2][1][2]  = -0.1e1 / v2 * C_MassUp * std::conj(V11);
    Curvature_Quark_F2H1[2][1][3]  = II / v2 * C_MassUp * std::conj(V11);
    Curvature_Quark_F2H1[2][3][6]  = 0.1e1 / v2 * C_MassDown;
    Curvature_Quark_F2H1[2][3][7]  = II / v2 * C_MassDown;
    Curvature_Quark_F2H1[2][5][2]  = -0.1e1 / v2 * C_MassCharm * std::conj(V21);
    Curvature_Quark_F2H1[2][5][3]  = II / v2 * C_MassCharm * std::conj(V21);
    Curvature_Quark_F2H1[2][9][2]  = -0.1e1 / v2 * C_MassTop * std::conj(V31);
    Curvature_Quark_F2H1[2][9][3]  = II / v2 * C_MassTop * std::conj(V31);
    Curvature_Quark_F2H1[3][0][2]  = V11 / v2 * C_MassDown;
    Curvature_Quark_F2H1[3][0][3]  = II * V11 / v2 * C_MassDown;
    Curvature_Quark_F2H1[3][2][6]  = 0.1e1 / v2 * C_MassDown;
    Curvature_Quark_F2H1[3][2][7]  = II / v2 * C_MassDown;
    Curvature_Quark_F2H1[3][4][2]  = V21 / v2 * C_MassDown;
    Curvature_Quark_F2H1[3][4][3]  = II * V21 / v2 * C_MassDown;
    Curvature_Quark_F2H1[3][8][2]  = V31 / v2 * C_MassDown;
    Curvature_Quark_F2H1[3][8][3]  = II * V31 / v2 * C_MassDown;
    Curvature_Quark_F2H1[4][3][2]  = V21 / v2 * C_MassDown;
    Curvature_Quark_F2H1[4][3][3]  = II * V21 / v2 * C_MassDown;
    Curvature_Quark_F2H1[4][5][6]  = 0.1e1 / v2 * C_MassCharm;
    Curvature_Quark_F2H1[4][5][7]  = -II / v2 * C_MassCharm;
    Curvature_Quark_F2H1[4][7][2]  = V22 / v2 * C_MassStrange;
    Curvature_Quark_F2H1[4][7][3]  = II * V22 / v2 * C_MassStrange;
    Curvature_Quark_F2H1[4][11][2] = 0.1e1 / v2 * C_MassBottom * V23;
    Curvature_Quark_F2H1[4][11][3] = II / v2 * C_MassBottom * V23;
    Curvature_Quark_F2H1[5][2][2]  = -0.1e1 / v2 * C_MassCharm * std::conj(V21);
    Curvature_Quark_F2H1[5][2][3]  = II / v2 * C_MassCharm * std::conj(V21);
    Curvature_Quark_F2H1[5][4][6]  = 0.1e1 / v2 * C_MassCharm;
    Curvature_Quark_F2H1[5][4][7]  = -II / v2 * C_MassCharm;
    Curvature_Quark_F2H1[5][6][2]  = -0.1e1 / v2 * C_MassCharm * std::conj(V22);
    Curvature_Quark_F2H1[5][6][3]  = II / v2 * C_MassCharm * std::conj(V22);
    Curvature_Quark_F2H1[5][10][2] = -0.1e1 / v2 * C_MassCharm * std::conj(V23);
    Curvature_Quark_F2H1[5][10][3] = II / v2 * C_MassCharm * std::conj(V23);
    Curvature_Quark_F2H1[6][1][2]  = -0.1e1 / v2 * C_MassUp * std::conj(V12);
    Curvature_Quark_F2H1[6][1][3]  = II / v2 * C_MassUp * std::conj(V12);
    Curvature_Quark_F2H1[6][5][2]  = -0.1e1 / v2 * C_MassCharm * std::conj(V22);
    Curvature_Quark_F2H1[6][5][3]  = II / v2 * C_MassCharm * std::conj(V22);
    Curvature_Quark_F2H1[6][7][6]  = 0.1e1 / v2 * C_MassStrange;
    Curvature_Quark_F2H1[6][7][7]  = II / v2 * C_MassStrange;
    Curvature_Quark_F2H1[6][9][2]  = -0.1e1 / v2 * C_MassTop * std::conj(V32);
    Curvature_Quark_F2H1[6][9][3]  = II / v2 * C_MassTop * std::conj(V32);
    Curvature_Quark_F2H1[7][0][2]  = 0.1e1 / v2 * C_MassStrange * V12;
    Curvature_Quark_F2H1[7][0][3]  = II / v2 * C_MassStrange * V12;
    Curvature_Quark_F2H1[7][4][2]  = V22 / v2 * C_MassStrange;
    Curvature_Quark_F2H1[7][4][3]  = II * V22 / v2 * C_MassStrange;
    Curvature_Quark_F2H1[7][6][6]  = 0.1e1 / v2 * C_MassStrange;
    Curvature_Quark_F2H1[7][6][7]  = II / v2 * C_MassStrange;
    Curvature_Quark_F2H1[7][8][2]  = 0.1e1 / v2 * C_MassStrange * V32;
    Curvature_Quark_F2H1[7][8][3]  = II / v2 * C_MassStrange * V32;
    Curvature_Quark_F2H1[8][3][2]  = V31 / v2 * C_MassDown;
    Curvature_Quark_F2H1[8][3][3]  = II * V31 / v2 * C_MassDown;
    Curvature_Quark_F2H1[8][7][2]  = 0.1e1 / v2 * C_MassStrange * V32;
    Curvature_Quark_F2H1[8][7][3]  = II / v2 * C_MassStrange * V32;
    Curvature_Quark_F2H1[8][9][6]  = 0.1e1 / v2 * C_MassTop;
    Curvature_Quark_F2H1[8][9][7]  = -II / v2 * C_MassTop;
    Curvature_Quark_F2H1[8][11][2] = 0.1e1 / v2 * C_MassBottom * V33;
    Curvature_Quark_F2H1[8][11][3] = II / v2 * C_MassBottom * V33;
    Curvature_Quark_F2H1[9][2][2]  = -0.1e1 / v2 * C_MassTop * std::conj(V31);
    Curvature_Quark_F2H1[9][2][3]  = II / v2 * C_MassTop * std::conj(V31);
    Curvature_Quark_F2H1[9][6][2]  = -0.1e1 / v2 * C_MassTop * std::conj(V32);
    Curvature_Quark_F2H1[9][6][3]  = II / v2 * C_MassTop * std::conj(V32);
    Curvature_Quark_F2H1[9][8][6]  = 0.1e1 / v2 * C_MassTop;
    Curvature_Quark_F2H1[9][8][7]  = -II / v2 * C_MassTop;
    Curvature_Quark_F2H1[9][10][2] = -0.1e1 / v2 * C_MassTop * std::conj(V33);
    Curvature_Quark_F2H1[9][10][3] = II / v2 * C_MassTop * std::conj(V33);
    Curvature_Quark_F2H1[10][1][2] = -0.1e1 / v2 * C_MassUp * std::conj(V13);
    Curvature_Quark_F2H1[10][1][3] = II / v2 * C_MassUp * std::conj(V13);
    Curvature_Quark_F2H1[10][5][2] = -0.1e1 / v2 * C_MassCharm * std::conj(V23);
    Curvature_Quark_F2H1[10][5][3] = II / v2 * C_MassCharm * std::conj(V23);
    Curvature_Quark_F2H1[10][9][2] = -0.1e1 / v2 * C_MassTop * std::conj(V33);
    Curvature_Quark_F2H1[10][9][3] = II / v2 * C_MassTop * std::conj(V33);
    Curvature_Quark_F2H1[10][11][6] = 0.1e1 / v2 * C_MassBottom;
    Curvature_Quark_F2H1[10][11][7] = II / v2 * C_MassBottom;
    Curvature_Quark_F2H1[11][0][2]  = 0.1e1 / v2 * C_MassBottom * V13;
    Curvature_Quark_F2H1[11][0][3]  = II / v2 * C_MassBottom * V13;
    Curvature_Quark_F2H1[11][4][2]  = 0.1e1 / v2 * C_MassBottom * V23;
    Curvature_Quark_F2H1[11][4][3]  = II / v2 * C_MassBottom * V23;
    Curvature_Quark_F2H1[11][8][2]  = 0.1e1 / v2 * C_MassBottom * V33;
    Curvature_Quark_F2H1[11][8][3]  = II / v2 * C_MassBottom * V33;
    Curvature_Quark_F2H1[11][10][6] = 0.1e1 / v2 * C_MassBottom;
    Curvature_Quark_F2H1[11][10][7] = II / v2 * C_MassBottom;
  }
  else
  {
    Curvature_Quark_F2H1[0][1][6]  = 0.1e1 / v2 * C_MassUp;
    Curvature_Quark_F2H1[0][1][7]  = -II / v2 * C_MassUp;
    Curvature_Quark_F2H1[0][3][0]  = V11 / v1 * C_MassDown;
    Curvature_Quark_F2H1[0][3][1]  = II * V11 / v1 * C_MassDown;
    Curvature_Quark_F2H1[0][7][0]  = 0.1e1 / v1 * C_MassStrange * V12;
    Curvature_Quark_F2H1[0][7][1]  = II / v1 * C_MassStrange * V12;
    Curvature_Quark_F2H1[0][11][0] = 0.1e1 / v1 * C_MassBottom * V13;
    Curvature_Quark_F2H1[0][11][1] = II / v1 * C_MassBottom * V13;
    Curvature_Quark_F2H1[1][0][6]  = 0.1e1 / v2 * C_MassUp;
    Curvature_Quark_F2H1[1][0][7]  = -II / v2 * C_MassUp;
    Curvature_Quark_F2H1[1][2][2]  = -0.1e1 / v2 * C_MassUp * std::conj(V11);
    Curvature_Quark_F2H1[1][2][3]  = II / v2 * C_MassUp * std::conj(V11);
    ...
    Curvature_Quark_F2H1[2][9][2]  = -0.1e1 / v2 * C_MassTop * std::conj(V31);
    Curvature_Quark_F2H1[2][9][3]  = II / v2 * C_MassTop * std::conj(V31);
    Curvature_Quark_F2H1[3][0][0]  = V11 / v1 * C_MassDown;
    Curvature_Quark_F2H1[3][0][1]  = II * V11 / v1 * C_MassDown;
    ...
    Curvature_Quark_F2H1[3][8][0]  = V31 / v1 * C_MassDown;
    Curvature_Quark_F2H1[3][8][1]  = II * V31 / v1 * C_MassDown;
    ...
    Curvature_Quark_F2H1[4][11][0] = 0.1e1 / v1 * C_MassBottom * V23;
    Curvature_Quark_F2H1[4][11][1] = II / v1 * C_MassBottom * V23;
    Curvature_Quark_F2H1[5][2][2]  = -0.1e1 / v2 * C_MassCharm * std::conj(V21);
    Curvature_Quark_F2H1[5][2][3]  = II / v2 * C_MassCharm * std::conj(V21);
    Curvature_Quark_F2H1[5][4][6]  = 0.1e1 / v2 * C_MassCharm;
    Curvature_Quark_F2H1[5][4][7]  = -II / v2 * C_MassCharm;
    ...
    Curvature_Quark_F2H1[6][9][2]  = -0.1e1 / v2 * C_MassTop * std::conj(V32);
    Curvature_Quark_F2H1[6][9][3]  = II / v2 * C_MassTop * std::conj(V32);
    Curvature_Quark_F2H1[7][0][0]  = 0.1e1 / v1 * C_MassStrange * V12;
    Curvature_Quark_F2H1[7][0][1]  = II / v1 * C_MassStrange * V12;
    ...
    Curvature_Quark_F2H1[7][8][0]  = 0.1e1 / v1 * C_MassStrange * V32;
    Curvature_Quark_F2H1[7][8][1]  = II / v1 * C_MassStrange * V32;
    Curvature_Quark_F2H1[8][3][0]  = V31 / v1 * C_MassDown;
    Curvature_Quark_F2H1[8][3][1]  = II * V31 / v1 * C_MassDown;
    Curvature_Quark_F2H1[8][7][0]  = 0.1e1 / v1 * C_MassStrange * V32;
    Curvature_Quark_F2H1[8][7][1]  = II / v1 * C_MassStrange * V32;
    Curvature_Quark_F2H1[8][9][6]  = 0.1e1 / v2 * C_MassTop;
    Curvature_Quark_F2H1[8][9][7]  = -II / v2 * C_MassTop;
    Curvature_Quark_F2H1[8][11][0] = 0.1e1 / v1 * C_MassBottom * V33;
    Curvature_Quark_F2H1[8][11][1] = II / v1 * C_MassBottom * V33;
    Curvature_Quark_F2H1[9][2][2]  = -0.1e1 / v2 * C_MassTop * std::conj(V31);
    Curvature_Quark_F2H1[9][2][3]  = II / v2 * C_MassTop * std::conj(V31);
    Curvature_Quark_F2H1[9][6][2]  = -0.1e1 / v2 * C_MassTop * std::conj(V32);
    Curvature_Quark_F2H1[9][6][3]  = II / v2 * C_MassTop * std::conj(V32);
    ...
    Curvature_Quark_F2H1[11][0][0]  = 0.1e1 / v1 * C_MassBottom * V13;
    Curvature_Quark_F2H1[11][0][1]  = II / v1 * C_MassBottom * V13;
    Curvature_Quark_F2H1[11][4][0]  = 0.1e1 / v1 * C_MassBottom * V23;
    Curvature_Quark_F2H1[11][4][1]  = II / v1 * C_MassBottom * V23;
    Curvature_Quark_F2H1[11][8][0]  = 0.1e1 / v1 * C_MassBottom * V33;
    Curvature_Quark_F2H1[11][8][1]  = II / v1 * C_MassBottom * V33;
