 ...
 * parameters.
 */
std::vector<std::string> Class_Potential_C2HDM::addLegendEFT() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<double> Class_Potential_C2HDM::getParamsEFT() const
{
...
double Class_Potential_C2HDM::SymFac_Higgs_OneLoop(
    const int &i,
    const int &j,
...
double Class_Potential_C2HDM::SymFac_Higgs_TwoLoop(const int &i,
                                                   const int &j) const
{
  (void)i;
  (void)j;
...
void Class_Potential_C2HDM::PerformVCTShift()
{
  // not implemented
}
