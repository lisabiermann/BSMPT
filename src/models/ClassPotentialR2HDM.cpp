 ...
 * parameters.
 */
std::vector<std::string> Class_Potential_R2HDM::addLegendEFT() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<double> Class_Potential_R2HDM::getParamsEFT() const
{
...
double Class_Potential_R2HDM::SymFac_Higgs_TempPowerTwo(
    const int &i,
    const int &j,
...
double Class_Potential_R2HDM::SymFac_Higgs_TempPowerFour(const int &i,
                                                         const int &j) const
{
  (void)i;
  (void)j;
