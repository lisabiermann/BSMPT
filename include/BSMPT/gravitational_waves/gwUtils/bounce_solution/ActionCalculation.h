...
#include "const_velocity_spline.h"
...
public:
  ...
  /**
   * @brief Current class path, can be changed by @ref PathDeformationCosmo
   *
   */
   ...
   */
  void SinglePathDeformationCosmo(double &stepsize,
                                  double &reductor,
                                  std::vector<double> &l,
                                  tk::spline &rho_l_spl,
   ...
   */
  void PathDeformationCosmo(std::vector<double> &l, tk::spline &rho_l_spl);
  /**
  ...
  /**
   * @brief Calculates the action of the bounce equation by deforming the given
